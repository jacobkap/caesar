...
[![](https://cranlogs.r-pkg.org/badges/caesar)](https://cran.rstudio.com/web/packages/caesar/index.html)

## Overview

The goal of caesar is to encrypt and decrypt strings using a simple Caesar cypher or a pseduorandom number generation. 
